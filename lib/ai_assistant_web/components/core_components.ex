defmodule AiAssistantWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AiAssistantWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AiAssistantWeb.Gettext, "errors", msg, opts)
    end
  end
